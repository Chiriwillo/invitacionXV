            ...
            <CarouselItem key={image.id}>
              <div className="p-1">
                <button
                  ...
                  className="w-full aspect-video rounded-lg overflow-hidden bg-gradient-to-br from-accent/50 to-background focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 block cursor-pointer"
